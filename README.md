...
This project is a production-ready Web API demonstrates Clean Architecture implementation with .NET 8. 
It provides a solid foundation for building scalable, maintainable enterprise applications with modern development practices .
